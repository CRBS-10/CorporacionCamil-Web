      ...
      <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="card text-center group hover:-translate-y-2 transition-transform duration-300">
                  <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-6 text-primary">
                  ...
                  <Link to="/services" className="text-accent font-semibold hover:text-accent-700">{t('btn_learn_more')}</Link>
              </div>
              {/* Hidráulica */}
              <div className="card text-center group hover:-translate-y-2 transition-transform duration-300">
                  <div className="w-16 h-16 bg-accent-100 rounded-full flex items-center justify-center mx-auto mb-6 text-accent">
              ...
              {/* Eléctrica */}
              <div className="card text-center group hover:-translate-y-2 transition-transform duration-300">
                  <div className="w-16 h-16 bg-secondary-100 rounded-full flex items-center justify-center mx-auto mb-6 text-secondary">
